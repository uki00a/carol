...
export { dirname, join } from "https://deno.land/std@0.54.0/path/mod.ts";
...
export {
  deferred,
  Deferred,
} from "https://deno.land/std@0.54.0/async/deferred.ts";
export {
  connectWebSocket,
  isWebSocketCloseEvent,
} from "https://deno.land/std@0.54.0/ws/mod.ts";
export { sprintf } from "https://deno.land/std@0.54.0/fmt/printf.ts";
export {
  assert,
  assertEquals,
  assertStrictEq,
